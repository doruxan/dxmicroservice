...
//{
//    public class GetTenantEntityLongTermReportQuery<TEntity, TDto> : IAsyncQuery<IList<TDto>>
...
//    public class GetTenantEntityLongTermReportQueryHandler<TEntity, TDto> : IAsyncQueryExecutor<GetTenantEntityLongTermReportQuery<TEntity, TDto>, IList<TDto>>
//    where TEntity : TenantEntity
//    {
...
//        public IList<TDto> Execute(GetTenantEntityLongTermReportQuery<TEntity, TDto> query, CancellationToken cancellationToken)
//        {
//            return Task.Run(async () => { return await ExecuteAsync(query, cancellationToken).ConfigureAwait(false); }).Result;
//        }

//        public async Task<IList<TDto>> ExecuteAsync(GetTenantEntityLongTermReportQuery<TEntity, TDto> query, CancellationToken cancellationToken)
//        {
